...
trainfile = open('bn_res_train.csv', 'wb')
valfile = open('bn_res_val.csv', 'wb')
lossfile = open('bn_res_loss.csv', 'wb')
trainwr = csv.writer(trainfile, quoting=csv.QUOTE_ALL)
valwr = csv.writer(valfile, quoting=csv.QUOTE_ALL)
losswr = csv.writer(lossfile, quoting=csv.QUOTE_ALL)
    ...
    if train:
        ...
        while step  <= training_iters:
            ...
            if step % display_step == 0:
                ...
                trainwr.writerow([acc5])
                losswr.writerow([loss])
            if step % val_step == 0:
        ...
        saver.restore(sess,"ban_res-2000")
